...
Try {
	...
	[string]$appVersion = '2008 - Named'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '02/01/2021'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\setup.exe" -Parameters "/configure O365-b2008-Named.xml" -WindowStyle "Hidden" -PassThru -WaitForMsiExec
